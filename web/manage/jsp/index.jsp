  ...
  <body>
        ...
        <div id="pf-hd">
            ...
            <div class="pf-user">
                ...
                <!--用户名-->
                <h4 class="pf-user-name ellipsis" id="">${sessionScope.username }</h4>
                   ...
                   <li>             	
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            <li class="active"><a href="javascript:addTab('任务查询','DataServlet')">调查任务查询</a></li>
                            <li><a href="javascript:addTab('调查任务录入','QueryServlet')">调查任务录入</a></li>
        ...
        $(function(){
        	...
        	$(".userInfo").on("click",function(){
        			$("#topWindow").window({
        				...
        				width:800,
        				height:300,
        				content:"<iframe scrolling='no' width='100%' height='100%' src='/MessageServlet'></iframe>"
        			})
        	})
            ...
            $(".exit").on("click",function(e){
                $.messager.confirm("警告","确定退出税源信息管理系统？",function(data){
                    if(data){
                        //发送退出系统请求
                        //退出成功重定向到登录页面
                        window.location.href="OutServlet"
                    }
                });
            });
        });
