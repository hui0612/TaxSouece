        ...
        <div title="纳税人信息" data-options="closable:false" class="basic-info">
            ...
            <table class="kv-table">
                ...
                <tr>
                    ...
                    <td class="kv-content"><input type="text" name="payerCode" id="payerCode" value="${requestScope.tax.payerCode }" ></td>
                    <td class="kv-label">纳税人名称</td>
                    <td class="kv-content">${requestScope.tax.payerName }</td>
                    <td class="kv-label">生产经营地址</td>
                    <td class="kv-content">${requestScope.tax.bizAddress }</td>
                </tr>
                <tr>
                    <td class="kv-label">所属税务机关</td>
                    <td class="kv-content">${requestScope.tax.organName }</td>
                    <td class="kv-label">行业</td>
                    <td class="kv-content">${requestScope.tax.industryName }</td>
                    <td class="kv-label">经营范围</td>
                    <td class="kv-content">${requestScope.tax.bizScope }</td>
                </tr>
                <tr>
                    <td class="kv-label">票种核定</td>
                    <td class="kv-content">${requestScope.tax.invoiceType }</td>
                    <td class="kv-label">法人代表人</td>
                    <td class="kv-content">${requestScope.tax.legalPerson }</td>
                    <td class="kv-label">法人身份证号</td>
                    <td class="kv-content">${requestScope.tax.legalIdCard }</td>
                </tr>
                <tr>
                    <td class="kv-label">主管财务</td>
                    <td class="kv-content">${requestScope.tax.finaceName }</td>
                    <td class="kv-label">财务身份证号</td>
                    <td class="kv-content">${requestScope.tax.finaceIdCard }</td>
                  </tr>
                <tr>                   
            ...
            <table class="kv-table">   	
                ...
                <tr>                	
                    ...
                    <td class="kv-content">
                      ...
                      <option value="-1">请选择下达部门必选项</option> 
                            <c:forEach items="${requestScope.off }" var="organ">
                    ...
                    <td class="kv-content">    	
	                    ...
	                    <option value="-1">请选择批准人</option>
	                      <c:forEach items="${requestScope.se }" var="taxer">
                ...
                <tr>
                  ...
                  <td class="kv-label">执行时间</td>
                    <td class="kv-content"><input type="text" name="executeTime" required></td>
  ...
  <script type="text/javascript">
      $(function(){
		...
		$("#payerCode").on("blur",function(){
			window.location.href = "QueryServlet?payerCode="+$("#payerCode").val()
		})
	})
